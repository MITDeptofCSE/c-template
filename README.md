...
2. If you intend to use local git and then provide a pull request then install the git on your local system [here](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git)
